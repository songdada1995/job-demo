package com.example.jobdemo.config.mybatis;
...
public class MybatisPrimaryConfig {
    ...
    static final String SCAN_PACKAGE = "com.example.jobdemo.mapper";
    static final String MAPPER_LOCATION = "classpath*:mapper/job/*.xml";
    static final String BEAN_NAME_PREFIX = "job";
    static final String DATA_SOURCE_PROPERTIES_PREFIX = "spring.datasource.job";
